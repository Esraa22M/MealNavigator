...
export const MenuListItem = ({ item, categoryLength, intialState }) => {
	...
	return (
		<Pressable onPress={handleCategoryNamePress.bind(this,item)}><View style={styles.itemContainer}>
...
const styles = StyleSheet.create({
	...
	activeContainer: { backgroundColor: colors.ui.primary, fontFamily:fonts.body , lineHeight:15},
