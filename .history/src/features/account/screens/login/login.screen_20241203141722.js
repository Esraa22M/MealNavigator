...
import { Spacer } from "../../../../components/spacer/spacer.component";import { AuthHeader } from "../../components/header/authentication-header.components";
			...
			<OuterWrapper>
				...
				<LoginContainer>
					<KeyboardAwareScrollView style={{ flex: 1 }}>
						...
						<Spacer size={"large"} postion={"top"} />
						<Spacer size={"large"} postion={"top"} />
						<KeyboardAwareScrollView><AuthInput
						...
						/>
						<Spacer size={"large"} postion={"bottom"} />
						<Spacer size={"large"} postion={"top"} />
						<AuthInput
