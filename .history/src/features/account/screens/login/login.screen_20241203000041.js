			...
			<OuterWrapper>
				...
				<LoginContainer>
					<KeyboardAvoidingView
						...
						style={{ flex: 1 }}
						keyboardVerticalOffset={200} // Offset to prevent overlapping (adjust as needed)
					>
						<ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={{flexGrow:1,flex:1}}>
							{/* <ImageContainer>
