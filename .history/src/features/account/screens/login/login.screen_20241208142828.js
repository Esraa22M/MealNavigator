				...
				<LoginContainer>
					<KeyboardAwareScrollView style={{ flex: 1 }}>
						...
						<AuthInput
							...
							right={<TextInput.Icon icon={isValidLoginData.email.icon} color={isValidLoginData.email.iconColor} />}
						...
						<AuthInput
							...
							right={<TextInput.Icon icon={isValidLoginData.password.icon} color={isValidLoginData.password.iconColor}/>}
