				...
				<LoginContainer>
					<KeyboardAwareScrollView style={{ flex: 1 }}>
						...
						<AuthInput
							...
							label={
								loginData.email.isFocused || isValidLoginData.email.isValid
									? ""
									: "Email"
							}
							error={!isValidLoginData.email?true:false}
						...
						<Spacer size={"large"} postion={"top"} />
						<AuthInput
						  	error={!isValidLoginData.password?true:false}
							...
							label={
								loginData.password.isFocused || isValidLoginData.password.isValid
									? ""
									: "Password"
							}
