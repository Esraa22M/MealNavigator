...
export const LoginScreen = () => {
	...
	// 	false
	// )}
	const { loginData, handleLoginDataChange,validateInput,isValidLoginData  } = useContext(AuthFormContext);
			...
			<OuterWrapper>
				...
				<LoginContainer>
					<KeyboardAwareScrollView style={{ flex: 1 }}>
						...
						<Spacer size={"large"} postion={"top"} />
						<AuthInput
							value={isValidLoginData.email?loginData.email.value:""}
							label={!loginData.email.isFocused ? "Email" : ""}
							placeholder={loginData.email?"is valid":"email is valid"}
							...
							onBlur={validateInput.bind(this, "email" ,loginData.email.value )}
						...
						<AuthInput
							...
							onBlur={validateInput.bind(this, "password" ,loginData.password.value )}
