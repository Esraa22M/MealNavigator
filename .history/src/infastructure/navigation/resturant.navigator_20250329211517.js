...
const RestaurantScreen = lazy(() =>
	import("../../features/restaurants/screens/restaurants-view/restaurants.screens").then(
	  (module) => ({ default: module.RestaurantScreen }) // لازم تحددي الـ default
	)
  );
...
export const ResturantsNavigator = () => {
	return (
		<ResturantsStack.Navigator screenOptions={{headerShown:false,presentation:'modal',  gestureEnabled: true
			...
			<ResturantsStack.Screen name="Resturants" component={RestaurantScreen} />
