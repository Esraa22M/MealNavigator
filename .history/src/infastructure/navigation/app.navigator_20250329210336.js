...
export const AppNavigator = () => {
	...
	return(
		<Tab.Navigator screenOptions={createScreenOptions}>
			<Tab.Screen component={ResturantsNavigator} name="All" options={{ tabBarLabel: "Home", tabBarButton: (props) => <TouchableOpacity {...props} onPress={() => {navigation.reset({index:0, routes:[{name:"Resturants"}]}) }} /> }} />
			<Tab.Screen component={MapScreenOverview} name="map" />
			<Tab.Screen component={FavouriresResturants} name="wishList" options={{ tabBarLabel: "Foodie Picks" }} />
