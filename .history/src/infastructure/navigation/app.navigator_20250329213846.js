...
const MapScreenOverview = lazy(() =>
	import("../../features/map/screens/map-overview/map-overview.screens").then((module) => ({
	  default: module.MapScreenOverview,
	}))
  );
  const FavouriresResturants = lazy(() =>
	import("../../features/resturants/screens/favourites-resturants/favourites-resturants.screens").then(
	  (module) => ({
  ...
  const Cart = lazy(() =>
	import("../../features/resturants/screens/cart-screen/cart.components").then((module) => ({
	  default: module.Cart,
	}))
  );
  const Settings = lazy(() =>
	import("../../features/account/screens/settings/settings.components").then((module) => ({
